...
class AppTheme {
  static const Color cBg = Color(0xFF06100E);
  static const Color cSurface = Color(0xFF0C1C19);
  static const Color cEdge = Color(0xFF142B26);
  static const Color cAccent = Color(0xFF14B8A6);
  static const Color cAccent2 = Color(0xFF5EEAD4);
  static const Color cInk = Color(0xFFF0FDFA);
